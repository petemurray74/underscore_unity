...
<article id="post-0" class="post no-results not-found">
	<header class="entry-header">
		<h1 class="entry-title"><?php _e( 'Nothing Found', 'unity' ); ?></h1>
	</header><!-- .entry-header -->
	...
	<div class="entry-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'unity' ); ?></p>
			<?php get_search_form(); ?>
